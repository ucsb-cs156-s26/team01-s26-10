...
|---------------------------|--------------|-----------|
| UCSBDiningCommonsMenuItem | Alex         | alyoon04|
| UCSBOrganization          | Om           | omkulkarni77|
| RecommendationRequest     | Srish        | EpicSRN021|
| MenuItemReview            | Kazu         | Kazu-Pang|
| HelpRequest               | Yuhang       | yuhangj554|
| Articles                  | Amit         | AmitKarthikeyan|
